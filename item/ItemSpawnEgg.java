...
public class ItemSpawnEgg extends ItemMonsterPlacer {
    ...
    public static Class[] spawnableEntities = {
            ...
            EntitySentry.class,
            EntityTote.class,
            EntityGolemNormal.class,
            EntityGolemPure.class,
            EntityWatcher.class,
            EntitySlider.class,
            EntityBobby.class,
            EntityHelios.class,
            EntityFactotum.class,
            EntityBeacon.class,
            EntityGuard.class,
            EntityOmni.class
    };
    ...
    // EntityTofuFairyだけをスポーンさせるようにItemMonsterPlacerのspawnCreatureを改変
