...
public class WorldChunkManagerEupraxia extends WorldChunkManager {
    ...
    public static ArrayList<BiomeGenBase> allowedBiomes = new ArrayList<BiomeGenBase>(Arrays.asList(giants,city));
    ...
    public WorldChunkManagerEupraxia(long par1, WorldType par3WorldType)
    {
        this();
    ...
    public WorldChunkManagerEupraxia(World par1World)
    {
